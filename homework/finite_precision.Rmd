...
> The relative error drops at first. The drop is linear on a log-log plot => polynomially fast; the slope looks like -2, which matches the theory. [I *think* the slope should strictly be "less than or equal to -2, eventually". But if the second order approximation is good over the range of $\Delta x$ maybe that effectively means -2.]
>
